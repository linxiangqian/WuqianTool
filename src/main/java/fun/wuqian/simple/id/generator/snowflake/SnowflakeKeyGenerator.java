...
package fun.wuqian.simple.id.generator.snowflake;
...
public final class SnowflakeKeyGenerator  {
    ...
    static {
        ...
        WORKER_ID = SimpleWorkerIdGenerator.createWorkerIdByIPSection();
    }
    ...
    public synchronized long generateKey() {
        long currentMilliseconds = this.getCurrentMillis();
    ...
    private long getWorkerId() {
        //long result = Long.valueOf(SimpleProperties.getKey("worker.id", String.valueOf(WORKER_ID)));
        long result = WORKER_ID;
        checkState( !(result >= 0L && result < WORKER_ID_MAX_VALUE) ," WORKER_ID 不合理，"+WORKER_ID);
        return result;
    }
    
    private int getMaxTolerateTimeDifferenceMilliseconds() {
        //return Integer.valueOf(SimpleProperties.getKey("max.tolerate.time.difference.milliseconds", String.valueOf(MAX_TOLERATE_TIME_DIFFERENCE_MILLISECONDS)));
    		return MAX_TOLERATE_TIME_DIFFERENCE_MILLISECONDS;
    }
    
    private long waitUntilNextTime(final long lastTime) {
        long result = this.getCurrentMillis();
    ...
    private void checkState(boolean condition,String msg,Object... args) {
        if (condition) {
    ...
    public static void main(String[] args) {
		SnowflakeKeyGenerator sss = new SnowflakeKeyGenerator();
		System.out.println(sss.generateKey());
		System.out.println(sss.generateKey());
		System.out.println(sss.generateKey());
		System.out.println(sss.generateKey());
		System.out.println(sss.generateKey());
